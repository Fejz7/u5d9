...
import java.util.List;
    ...
    public class BlogsController {
        ...
        @PostMapping("/{blogId}/upload-cover")
        public String uploadBlogCover(@PathVariable int blogId, @RequestParam("file") MultipartFile file) {
            return blogsService.uploadCover(blogId, file);
        }
